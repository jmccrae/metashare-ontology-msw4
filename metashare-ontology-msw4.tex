...
has been implemented as an XML Schema Definition (XSD) and descriptions of specific LRs are available as XML documents.
...
The use of Semantic Web techniques enable standardized means of linking and
...
\item administrative components relevant to all LRs, e.g. {\tt
    ...
    distributionInfo} (licensing and intellectual property rights information), {\tt usageInfo}
...
\item components specific to the resource type (corpus, lexical/conceptual
    ...
    image) allow the encoding of information relevant to text or audio and corpora
    or lexical/conceptual resources (e.g. language, formatting, classification).
\end{itemize} 
...
\item Grouping similar elements under novel superclasses, e.g. {\tt
    ...
    subclasses better reflecting the relation between them. Similarly, the superclass
...
(Creative Commons licences for data resources and Free Open Source Software for tools and
...
so it may be used independently of the META-SHARE ontology.
