...
description of metadata of linguistic resources. The work described here is only
a first step to harmonization in that there are still a number of challenges
...
services can be dissevered across providers and repositories. The mechanisms for
...
scale, services should support parallelization and streaming and support
...
simple and stateless. We believe that the development of common vocabularies
such as the one presented in paper should enable the development of this
