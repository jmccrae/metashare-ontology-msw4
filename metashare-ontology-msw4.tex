...
The central entity of the META-SHARE schema is the LR per se, which encompasses
both {\bf data sets} (textual, audio and multimodal/multimedia corpora, lexical
data, ontologies, terminologies, computational grammars, language models, etc.)
