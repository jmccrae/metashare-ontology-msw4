...
\label{sec:linghub}
LingHub~\footnote{\url{http://linghub.org}} is a meta-repository or portal containing metadata from a wide range of
language resources. It does not genuinely connect met data, but merely harvests metadata from other repositories thus representing an index or access hub for the discovery of language resources hosted in other repositories.
