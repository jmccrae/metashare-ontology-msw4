...
The core of the schema is the \begin{small}\verb|resourceInfo|\end{small} \textcolor{red}{(VR: Should we format XML elements with this font?)} component (Figure 1), which subsumes components that combine together to provide the full description of a resource and its lifecycle. For each LR there are:
\begin{itemize}
